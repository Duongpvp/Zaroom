            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
                    <div class="content-wthree">
                        <h2 class="title" style="margin-left: 20%;">ĐĂNG KÝ TÀI KHOẢN</h2>
                        ...
                        <form action="" method="post">
                            <input type="text" class="name" name="name" placeholder="Nhập tên tài khoản" value="<?php if (isset($_POST['submit'])) {
                                                                                                                    echo $name;
                                                                                                                } ?>" required>
                            <input type="email" class="email" name="email" placeholder="Nhập Email" value="<?php if (isset($_POST['submit'])) {
                                                                                                                echo $email;
                                                                                                            } ?>" required>
