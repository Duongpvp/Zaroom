        ...
        if(isset($_POST['submit'])){
            ...
            $row = mysqli_fetch_assoc($query);
              ...
              if(!preg_match($partten, $password_check, $matchs)){
                ...
                $sql = "UPDATE users SET name='$name', email='$email',password='$password', permission='$permission' WHERE email='$email'";
                mysqli_query($conn, $sql);
              } 
            }else{
                $msg = "<div class='alert alert-danger'>Email sai</div>";
              }
        }
                  ...
                  <div class="col-lg-8 col-md-4 mb-4">
                    <div class="card h-100">
                      <div class="card-header d-flex align-items-center">
                        <h4 class="card-title m-9 me-2">Sửa tài khoản</h4>
                      </div>
                      <div class="card-body">
                        <form id="formAccountSettings" method="POST">
                          ...
                          <div class="mt-2">
                            <button type="submit" class="btn btn-primary me-2" name="submit" value="submit">Sửa tài khoản</button>
