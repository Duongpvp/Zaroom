...
if (isset($_GET['idUser'])) {
  $idUser = $_GET['idUser'];
  $sql = "DELETE FROM room_chat WHERE id_user=$idUser";
  mysqli_query($conn, $sql);
  $sql = "DELETE FROM class_user WHERE id_user=$idUser";
  mysqli_query($conn, $sql);
                  ...
                  <div class="d-flex align-items-end row">
                    <div class="col-sm-12">
                      <div class="card-body pt-3 pb-0">
                        <h5 class="create-title text-primary"><?php echo $msg; ?></h5>
                      </div>
                      <hr class="my-0" />
                    </div>
                  </div>
              ...
              <div class="col-lg-8 col-md-8 mb-4">
                <div class="card h-100">
                  <div class="card-header d-flex align-items-center">
                    <h4 class="card-title m-9 me-2">Thông tin tài khoản</h4>
                  </div>
                  <div class="card-body">
                    <form id="formAccountSettings" method="POST">
                      <div class="mb-3 col-md-6">
                        <label for="name" class="form-label">Tên người dùng</label>
                        <input class="form-control" type="text" id="name" name="name" placeholder="Nhập tên người dùng" autofocus />
                      </div>
                      <div class="mb-3 col-md-6">
                      ...
                      <div class="mb-3 col-md-6">
                        <label for="conf-password" class="form-label">Xác nhận mật khẩu</label>
                        <input class="form-control" type="password" id="conf-password" name="conf-password" placeholder="Nhập lại mật khẩu" />
                      </div>
                      <div class="mt-3">
                        <label for="ad-permission" class="radio-label">Admin</label>
                        <input class="radio-control" type="radio" id="ad-permission" name="permission" value="2" />
                        <label for="tea-permission" class="radio-label">Giáo viên</label>
                        <input class="radio-control" type="radio" id="tea-permission" name="permission" value="1" />
                        <label for="stu-permission" class="radio-label">Sinh viên</label>
                        <input class="radio-control" type="radio" id="stu-permission" name="permission" value="0" />
                      </div>
                      <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-2" name="submit" value="submit">Tạo tài khoản </button>
              ...
              <div class="col-lg-4 col-md-4 mb-4">
                <div class="card h-100">
                  <div class="card-header d-flex align-items-center justify-content-between">
                    <h4 class="card-title m-0 me-2">Danh sách tài khoản</h4>
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-12 mb-2 md-0">
                        ...
                        if (mysqli_num_rows($query) > 0) {
                          while ($row = mysqli_fetch_assoc($query)) {
                            echo '<div class="row">
                                    <h5 class="col-8 mb-2 pt-1">' . $row['name'] . '</h5>
                                    <form method="GET" class="col-4 mb-2 ">
                                        <a class="btn btn-danger btn-sm" href="?idUser=' . $row['id'] . '"> Xóa </a>
                                    </form>
                                  </div>';
                          }
                        }
